...
// dont worry about over time - compare home team goals to away team goals
function getWinners(array, getFinals) {
    const winners = getFinals(array)
...
function getWinnersByYear(array, getYears, getWinners) {
    const arrayYears = getYears(array, getFinals);
    const arrayWinners = getWinners(array, getFinals).map(function(item,index){
...
function getAverageGoals(getFinals) {
  const avgGoals = getFinals.reduce(function(acc, item){
